...
from stable_nalu.layer.reciprocal_nmu import ReciprocalNMULayer
from stable_nalu.layer.concat_reciprocal_nmu import ConcatReciprocalNMULayer
from stable_nalu.layer.concat_reciprocal_nmu_sign_retrieval import ConcatReciprocalNMUSignRetrievalLayer
from stable_nalu.layer.concat_reciprocal_nmu_gated_sign_retrieval import ConcatReciprocalNMUGatedSignRetrievalLayer
from stable_nalu.layer.normalisation_unit import NNULayer
...
unit_name_to_layer_class = {
    ...
    'MultiWeightNAU': MultiWeightNAULayer,
    'EnsembleGumbelNAU': EnsembleGumbelSoftmaxNAU,
    'SigmoidNAU': SigmoidNAU,
    'ScaledSigmoidNAU': ScaledSigmoidNAU,

    'NRU': ReciprocalNMULayer,
    'NMRU': ConcatReciprocalNMULayer,
    'SignNMRU': ConcatReciprocalNMUSignRetrievalLayer,
    'GatedSignNMRU': ConcatReciprocalNMUGatedSignRetrievalLayer,
    'NNU': NNULayer,
    'iNALU': INALULayer,
}
